...
from typing import TYPE_CHECKING, Annotated, Any, Protocol, get_args, get_origin, get_type_hints, runtime_checkable
...
# ---------------------------------------------------------------------------- #
# v0.13 — Annotated[T, Depends(factory)] DI path (additive; Provider stays).   #
# ---------------------------------------------------------------------------- #
