...
A2K_DI_ANNOTATED = "A2K-DI-ANNOTATED"
A2K_DI_IMPORT_LEGACY = "A2K-DI-IMPORT-LEGACY"
A2K_DI_IMPORT_SLOW = "A2K-DI-IMPORT-SLOW"
A2K_DI_KWONLY = "A2K-DI-KWONLY"
...
def _build_rules_table() -> tuple[tuple[str, _RuleFn], ...]:
    ...
    return (
        ...
        (A2K013, rule_a2k013),
        (A2K014, rule_a2k014),
        (A2K_DI_ANNOTATED, rule_di_annotated),
        (A2K_DI_IMPORT_LEGACY, rule_di_import_legacy),
        (A2K_DI_IMPORT_SLOW, rule_di_import_slow),
        (A2K_DI_KWONLY, rule_di_kwonly),
