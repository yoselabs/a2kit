...
"""
    ...
    assert 'surfaces=("cli",)' in out[0]


def test_login_with_explicit_surfaces_does_not_fire() -> None:
    src = """
import a2kit
...
def test_explicit_surfaces_all_suppresses() -> None:
    src = """
import a2kit
@a2kit.read(surfaces=("mcp","api","cli"))
async def login() -> dict:
    return {}
"""
    assert _findings(src) == []
