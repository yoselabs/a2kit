...
def test_primitive_returns_raise_invalid_tool_return_type(return_type: type, type_name: str) -> None:
    ...
    async def fn() -> return_type:  # type: ignore[valid-type]  # ty: ignore[invalid-type-form]  # why: annotation references a module path used as a sentinel; deliberate to verify the introspection failure mode
