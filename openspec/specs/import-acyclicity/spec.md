# import-acyclicity Specification

## Purpose
TBD - created by archiving change decouple-import-cycles. Update Purpose after archive.
## Requirements
...
lazy import of `a2kit.packages.log` (the `format_condensed_line` wire-format
